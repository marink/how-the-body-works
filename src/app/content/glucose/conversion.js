...
export default function Conversion() {
    return (
        <>
            <h2>How Carbohydrates Are Digested and Converted into Glucose</h2>
            <p>Carbohydrate digestion is a step-by-step process that breaks down complex food into simple glucose that our cells can
                use for energy. Here is how the body converts carbohydrates from a meal into glucose in the bloodstream:</p>
            <ol>
                <li><strong>Mouth:</strong> The process begins as soon as you start chewing. Saliva contains <em>amylase</em>, an
                    ...
                    break down while still in your mouth.</li>
                <li><strong>Stomach:</strong> Once swallowed, the chewed food (now called a <em>bolus</em>) reaches the stomach. The
                    ...
                    semi-liquid mixture called <em>chyme</em>&#8203;:contentReference[ oaicite-9]/index=9/.</li>
                <li><strong>Small Intestine:</strong> The chyme is gradually released into the small intestine. Here, the pancreas
                    ...
                    galactose from certain foods).</li>
                <li><strong>Absorption into Bloodstream:</strong> The resulting single sugars are then absorbed through the walls of
            ...
            <p>In summary, all digestible carbohydrates—whether they come from a bowl of oatmeal or a candy bar—are ultimately
                ...
                excreted, though fiber also feeds gut bacteria and aids digestion without converting to glucose.</p>
            <p>Check <a href="/endocrine-system/hyperglycemia">here</a> for extreeme effects of glucose on human cells.</p>
        </>
    );
}
